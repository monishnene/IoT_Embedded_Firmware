...
int main(void)
{
    ...
    GRAPHICS_Clear();
	GRAPHICS_AppendString("Monish LCD");
    ...
    letimer_init();
    srand(reset_counter.data[0]);
    random_number = rand();
    GRAPHICS_AppendString("MITM");
    GRAPHICS_AppendString("Security");
    GRAPHICS_AppendString("Passcode");
