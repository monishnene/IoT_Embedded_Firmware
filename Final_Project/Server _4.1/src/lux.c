...
/***********************************************************************
 * @brief i2c_slave_clear()
 * clear slaves on i2c bus
 ***********************************************************************/
...
/***********************************************************************
 * @brief read_channel()
 * read a particular channel of the lux sensor
 * @param channel_address address of the channel to be read
 ***********************************************************************/
...
/***********************************************************************
 * @brief lux_read()
 * read the brightness value from lux sensor
 ***********************************************************************/
